        ...
        <div class="container-fluid">
          ...
          <form action="" method="post">
            ...
            <div class="modal-body">
                    ...
                    <div class="form-group">
                        <input type="text" class="form-control" id="cekDenom" name="cekDenom" placeholder="SubMenu Title">
                    </div>
                    <div class="form-group">
                        <input type="text" class="form-control" id="portin" name="portin" placeholder="SubMenu Title">
                    </div>
                    <div class="form-group">
                        <input type="text" class="form-control" id="portout" name="portout" placeholder="SubMenu Title">
                    </div>    
