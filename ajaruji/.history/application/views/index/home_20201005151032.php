            ...
            <div class="container">
                <div class="row">
                    <div class="uji-header col-12 pt-70 pb-70 text-center">
                        ...
                        <a href="<?= base ?>" rel="" class="main-btn3 mt-80 wow fadeInLeftBig" data-wow-duration="1.3s" data-wow-delay="0.8s" style="visibility: visible; animation-duration: 1.3s; animation-delay: 0.8s; animation-name: fadeInLeftBig;">Mulai Uji Coba</a>
                    </div>
                </div>
            </div>
        </div>
