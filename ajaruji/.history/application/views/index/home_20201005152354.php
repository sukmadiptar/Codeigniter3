                ...
                <div class="row">
                    ...
                    <div class="container fitur">
                        <div class="row d-flex justify-content-center">
                            <div class="card-fitur text-center col-lg-2 col-md-4 col-sm-12 pb-70 text-center fadeInLeftBig" data-wow-duration="1.4s" style="visibility: visible; animation-duration: 1.4s; animation-name: fadeInLeftBig;">
